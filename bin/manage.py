...
from impact_cycling import create_app, db
from impact_cycling.models import User, Role

app = create_app()
migrate = Migrate(app, db, directory="impact_cycling/migrations")
...
def init_db(migration):
    ...
    if migration:
        ...
        db.create_all()
        db.session.commit()
        cfg = alembic.config.Config("impact_cycling/migrations/alembic.ini")
